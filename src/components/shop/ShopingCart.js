...
const ShopingCart = () => {
    ...
    return (
        <>
            <section className="cart_area my-5">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="product_count">
                                                <input type="text" name="qty" id="sst" maxLength={12} defaultValue={1} title="Quantity:" value={count} className="input-text qty" />
                                                <button onClick={onclick}  className="increase items-count" type="button"><i className="lnr lnr-chevron-up" /></button>
                                                <button  className="reduced items-count" type="button"><i className="lnr lnr-chevron-down" /></button>
                                            </div>
                                        </td>
                                        <td style={{textAlign: "center"}}>
                                            <Link className="cart">
                                                <span style={{fontSize:" 20px", color: "red"}} className="ti-trash"></span>
                                            </Link>
                                        </td>
                                    </tr>
